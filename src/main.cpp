...
uint256 hashGenesisBlock("0xe2671cc3b8b95a53c50c980d729f47a292c623e8571d54d9ecc6d69a7b41bf81");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 900000); // Testcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 14 * 24 * 60 * 60; // Testcoin: 3.5 days
static const int64 nTargetSpacing = 0.5 * 60; // Testcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x628fa04f718cdc7492f04b0d9a2bd97732650b0732e6ba40b08c67152685a0f4");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "3/15 2018 TEST DAY";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 400 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04c215697ebde93ec26fe94a1fd181f702ae7e98dccfbc1210ed1f2ea46428561b0b9275c8623a997be35ec7058734349eb0c482121e6f08bc97424fa1726aa1a5") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1521080203;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084882320;

        if (fTestNet)
        {
            block.nTime    = 1521080209;
            block.nNonce   = 388025031;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xa675bc99e4ba3ac18aef9f7f47e33ece50bb00e9957e6e5d9b851225496380a7"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x12, 0x23, 0x34, 0x56 }; // Testcoin: increase each by adding 2 to bitcoin's value.
